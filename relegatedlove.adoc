...
With improbable speed, a group of immaculate goth women charged through the door of the Detroit City Clubhouse.
...
== Chapter Eleven (After the ransom, sending in Ben)
